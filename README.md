...
- **Υδροπονία**: `hydroponic.system_type: "drip_substrate"` (rockwool), με πραγματική
  ...
  ουσία καρπού + καμπανοειδές risk (BER σε υψηλό EC, έλλειψη θρεπτικών σε χαμηλό EC), pH→
  διαθεσιμότητα θρεπτικών (καμπανοειδές γύρω από 5.5-6.5), και N/K/Mg/B recipe adequacy — όλα
  interactive sliders στο tab «Συνταγή γεωπονίας». Ό,τι δεν αναφέρθηκε (P/S/Fe/Mn/Zn/Cu/Mo)
  παραμένει πληροφοριακό, χωρίς μοντελοποίηση.
...
- **Phase-aware κλιματικό μοντέλο**: διαφορετικά setpoints θέρμανσης/CO2/
  ...
  καρποφορία), αντί για σταθερά setpoints σε όλη τη διάρκεια — **επόμενο βήμα**
  τώρα που η υδροπονία (Level A + B, ολοκληρώθηκε 2026-08-29) έχει κλείσει
  (αποφασίστηκε 2026-08-26).
