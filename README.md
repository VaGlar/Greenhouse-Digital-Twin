...
- **Υδροπονία**: `hydroponic.system_type: "drip_substrate"` (rockwool), με πραγματική
  ...
  `docs/assumptions/hydroponics.md` Level A) και EC→ξηρή ουσία καρπού + κίνδυνος BER
  (Blossom End Rot) + N/K/Mg/B recipe adequacy πάνω στο marketable yield (Level B, βλ. ίδιο
  αρχείο). Ό,τι δεν αναφέρθηκε (pH's πραγματική επίδραση σε διαθεσιμότητα θρεπτικών, P/S/Fe/
  Mn/Zn/Cu/Mo) παραμένει πληροφοριακό, χωρίς μοντελοποίηση.
