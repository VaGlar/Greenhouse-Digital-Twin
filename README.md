...
- **Η ενεργή αφύγρανση δεν έχει όριο χωρητικότητας** — θεωρείται ότι πάντα
  φτάνει τον στόχο υγρασίας, χωρίς πραγματικό kg-νερού/ώρα όριο (δεν υπάρχει
  ακόμα το spec του πραγματικού μηχανήματος).
- **Καμία λεπτομερής υδροπονία** — το σύστημα (π.χ. NFT) είναι μόνο ένα flag,
  χωρίς μοντελοποίηση θρεπτικών/EC/pH.
...
- **Βαθύτερη μοντελοποίηση υδροπονίας** (θρεπτικά, EC/pH, στόχος drainage %)
  αν χρειαστεί.
