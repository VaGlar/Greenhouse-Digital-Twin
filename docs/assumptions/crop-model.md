...
| `CO2_HALF_SAT_PPM` | 200.0 | **PLACEHOLDER** | Same — plausible shape (response saturates around 1000–1200 ppm per the docstring's own comment) but not individually sourced. |
